...
$jobslist = (
    "docker cp .\\assets\\micro211\\ $($con_id):\C:\\",
    "docker cp .\\assets\\.steamcmd\\ $($con_id):\C:\\Users\\ContainerAdministrator\\",
    "docker cp .\\assets\\Git\\ $($con_id):\C:\\Users\\ContainerAdministrator\\",
    "docker cp  .\\assets\\PowerShell\\ $($con_id):\C:\Users\ContainerAdministrator\Documents\")
...
docker exec $($con_id) C:\Users\ContainerAdministrator\.steamcmd\steamcmd.exe
